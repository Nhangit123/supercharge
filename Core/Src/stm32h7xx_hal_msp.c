...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PC5     ------> ADC1_INP8
    */
    HAL_GPIO_DeInit(GPIOA, GPIO_PIN_4|adc1_channel_7_isense_Pin);

    HAL_GPIO_DeInit(GPIOC, adc1_channel_4_voutsense_Pin|adc1_channel_8_vinsense_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOD, MODBUS_TX2_Pin|MODBUS_RX2_Pin);
